...
- [ ] **Visual verdict on the rebuilt sky** — playtest DONE (2026-08-26, screenshots in session scratchpad `sky-playtest/`): day storm/bolts/shafts/parallax/seams all good; findings await owner's eyes — (1) night storm cloud bodies invisible (floating caps, detached shafts), (2) HUD text drowns in near deck (worst at night), (3) storm thins at 1280 wide (768 is the target look), minor: base-slab "tray" edges, olive cast in far haze
